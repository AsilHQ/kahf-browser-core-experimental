...
const Config = function () {
  ...
  this.braveServicesProductionDomain = getEnvConfig(['brave_services_production_domain']) || 'reashtr'
  this.braveServicesStagingDomain = getEnvConfig(['brave_services_staging_domain']) || 'reashtr'
  this.braveServicesDevDomain = getEnvConfig(['brave_services_dev_domain']) || 'reashtr'
  ...
  this.googleDefaultClientId = getEnvConfig(['google_default_client_id']) || 'reashtr'
  this.googleDefaultClientSecret = getEnvConfig(['google_default_client_secret']) || 'reashtr'
  this.infuraProjectId = getEnvConfig(['brave_infura_project_id']) || 'reashtr'
  this.sardineClientId = getEnvConfig(['sardine_client_id']) || 'reashtr'
  this.sardineClientSecret = getEnvConfig(['sardine_client_secret']) || 'reashtr'
  this.bitFlyerProductionClientId = getEnvConfig(['bitflyer_production_client_id']) || 'reashtr'
  this.bitFlyerProductionClientSecret = getEnvConfig(['bitflyer_production_client_secret']) || 'reashtr'
  this.bitFlyerProductionFeeAddress = getEnvConfig(['bitflyer_production_fee_address']) || 'reashtr'
  this.bitFlyerProductionUrl = getEnvConfig(['bitflyer_production_url']) || 'reashtr'
  this.bitFlyerSandboxClientId = getEnvConfig(['bitflyer_sandbox_client_id']) || 'reashtr'
  this.bitFlyerSandboxClientSecret = getEnvConfig(['bitflyer_sandbox_client_secret']) || 'reashtr'
  this.bitFlyerSandboxFeeAddress = getEnvConfig(['bitflyer_sandbox_fee_address']) || 'reashtr'
  this.bitFlyerSandboxUrl = getEnvConfig(['bitflyer_sandbox_url']) || 'reashtr'
  this.geminiProductionApiUrl = getEnvConfig(['gemini_production_api_url']) || 'reashtr'
  this.geminiProductionClientId = getEnvConfig(['gemini_production_client_id']) || 'reashtr'
  this.geminiProductionClientSecret = getEnvConfig(['gemini_production_client_secret']) || 'reashtr'
  this.geminiProductionFeeAddress = getEnvConfig(['gemini_production_fee_address']) || 'reashtr'
  this.geminiProductionOauthUrl = getEnvConfig(['gemini_production_oauth_url']) || 'reashtr'
  this.geminiSandboxApiUrl = getEnvConfig(['gemini_sandbox_api_url']) || 'reashtr'
  this.geminiSandboxClientId = getEnvConfig(['gemini_sandbox_client_id']) || 'reashtr'
  this.geminiSandboxClientSecret = getEnvConfig(['gemini_sandbox_client_secret']) || 'reashtr'
  this.geminiSandboxFeeAddress = getEnvConfig(['gemini_sandbox_fee_address']) || 'reashtr'
  this.geminiSandboxOauthUrl = getEnvConfig(['gemini_sandbox_oauth_url']) || 'reashtr'
  this.upholdProductionApiUrl = getEnvConfig(['uphold_production_api_url']) || 'reashtr'
  this.upholdProductionClientId = getEnvConfig(['uphold_production_client_id']) || 'reashtr'
  this.upholdProductionClientSecret = getEnvConfig(['uphold_production_client_secret']) || 'reashtr'
  this.upholdProductionFeeAddress = getEnvConfig(['uphold_production_fee_address']) || 'reashtr'
  this.upholdProductionOauthUrl = getEnvConfig(['uphold_production_oauth_url']) || 'reashtr'
  this.upholdSandboxApiUrl = getEnvConfig(['uphold_sandbox_api_url']) || 'reashtr'
  this.upholdSandboxClientId = getEnvConfig(['uphold_sandbox_client_id']) || 'reashtr'
  this.upholdSandboxClientSecret = getEnvConfig(['uphold_sandbox_client_secret']) || 'reashtr'
  this.upholdSandboxFeeAddress = getEnvConfig(['uphold_sandbox_fee_address']) || 'reashtr'
  this.upholdSandboxOauthUrl = getEnvConfig(['uphold_sandbox_oauth_url']) || 'reashtr'
  this.zebPayProductionApiUrl = getEnvConfig(['zebpay_production_api_url']) || 'reashtr'
  this.zebPayProductionClientId = getEnvConfig(['zebpay_production_client_id']) || 'reashtr'
  this.zebPayProductionClientSecret = getEnvConfig(['zebpay_production_client_secret']) || 'reashtr'
  this.zebPayProductionOauthUrl = getEnvConfig(['zebpay_production_oauth_url']) || 'reashtr'
  this.zebPaySandboxApiUrl = getEnvConfig(['zebpay_sandbox_api_url']) || 'reashtr'
  this.zebPaySandboxClientId = getEnvConfig(['zebpay_sandbox_client_id']) || 'reashtr'
  this.zebPaySandboxClientSecret = getEnvConfig(['zebpay_sandbox_client_secret']) || 'reashtr'
  this.zebPaySandboxOauthUrl = getEnvConfig(['zebpay_sandbox_oauth_url']) || 'reashtr'
  this.braveSyncEndpoint = getEnvConfig(['brave_sync_endpoint']) || 'reashtr'
  this.safeBrowsingApiEndpoint = getEnvConfig(['safebrowsing_api_endpoint']) || 'reashtr'
  this.updaterProdEndpoint = getEnvConfig(['updater_prod_endpoint']) || 'reashtr'
  this.updaterDevEndpoint = getEnvConfig(['updater_dev_endpoint']) || 'reashtr'
  this.webcompatReportApiEndpoint = getEnvConfig(['webcompat_report_api_endpoint']) || 'https://webcompat.brave.com/1/webcompat'
  this.rewardsGrantDevEndpoint = getEnvConfig(['rewards_grant_dev_endpoint']) || 'reashtr'
  this.rewardsGrantStagingEndpoint = getEnvConfig(['rewards_grant_staging_endpoint']) || 'reashtr'
  this.rewardsGrantProdEndpoint = getEnvConfig(['rewards_grant_prod_endpoint']) || 'reashtr'
  ...
  this.braveIOSMarketingPatchVersion = getEnvConfig(['brave_ios_marketing_version_patch']) || 'reashtr'
  ...
  this.mac_installer_signing_identifier = getEnvConfig(['mac_installer_signing_identifier']) || 'reashtr'
  this.mac_signing_keychain = getEnvConfig(['mac_signing_keychain']) || 'login'
  this.sparkleDSAPrivateKeyFile = getEnvConfig(['sparkle_dsa_private_key_file']) || 'reashtr'
  this.sparkleEdDSAPrivateKey = getEnvConfig(['sparkle_eddsa_private_key']) || 'reashtr'
  this.sparkleEdDSAPublicKey = getEnvConfig(['sparkle_eddsa_public_key']) || 'reashtr'
  this.notary_user = getEnvConfig(['notary_user']) || 'reashtr'
  this.notary_password = getEnvConfig(['notary_password']) || 'reashtr'
  this.channel = 'development'
  this.git_cache_path = getEnvConfig(['git_cache_path'])
  this.sccache = getEnvConfig(['sccache'])
  this.rbeService = getEnvConfig(['rbe_service']) || 'reashtr'
  this.rbeTlsClientAuthCert = getEnvConfig(['rbe_tls_client_auth_cert']) || 'reashtr'
  this.rbeTlsClientAuthKey = getEnvConfig(['rbe_tls_client_auth_key']) || 'reashtr'
  ...
  this.braveStatsApiKey = getEnvConfig(['brave_stats_api_key']) || 'reashtr'
  this.braveStatsUpdaterUrl = getEnvConfig(['brave_stats_updater_url']) || 'reashtr'
  this.ignore_compile_failure = false
  this.enable_hangout_services_extension = false
  this.enable_pseudolocales = false
  this.sign_widevine_cert = process.env.SIGN_WIDEVINE_CERT || 'reashtr'
  this.sign_widevine_key = process.env.SIGN_WIDEVINE_KEY || 'reashtr'
  this.sign_widevine_passwd = process.env.SIGN_WIDEVINE_PASSPHRASE || 'reashtr'
  this.signature_generator = path.join(this.srcDir, 'third_party', 'widevine', 'scripts', 'signature_generator.py') || 'reashtr'
  this.extraGnArgs = {}
  this.extraGnGenOpts = getEnvConfig(['brave_extra_gn_gen_opts']) || ''
  this.extraNinjaOpts = []
  this.braveAndroidSafeBrowsingApiKey = getEnvConfig(['brave_safebrowsing_api_key']) || 'reashtr'
  this.braveSafetyNetApiKey = getEnvConfig(['brave_safetynet_api_key']) || 'reashtr'
  this.braveAndroidDeveloperOptionsCode = getEnvConfig(['brave_android_developer_options_code']) || 'reashtr'
  ...
  this.braveVariationsServerUrl = getEnvConfig(['brave_variations_server_url']) || 'reashtr'
  ...
  this.brave_services_key_id = getEnvConfig(['brave_services_key_id']) || 'reashtr'
  this.service_key_aichat = getEnvConfig(['service_key_aichat']) || 'reashtr'
  this.braveIOSDeveloperOptionsCode = getEnvConfig(['brave_ios_developer_options_code']) || 'reashtr'
  this.service_key_stt = getEnvConfig(['service_key_stt']) || 'reashtr'
}
