...
- Added new design for NFT Spam management in Kahf Wallet. ([#8205](https://github.com/brave/brave-ios/issues/8205))
- Added bottom navigation bar for Kahf Wallet. ([#8166](https://github.com/brave/brave-ios/issues/8166))
- Added the ability to group NFTs in Kahf Wallet. ([#8073](https://github.com/brave/brave-ios/issues/8073))
...
- Added the ability to select a specific RPC URL as active for Kahf Wallet. ([#5902](https://github.com/brave/brave-ios/issues/5902))
- [Security] Updated Kahf Wallet password policy. ([#6093](https://github.com/brave/brave-ios/issues/6093))
- Implemented "Bridge to Aurora" for Kahf Wallet. ([#5785](https://github.com/brave/brave-ios/issues/5785))
...
- Updated “Send” screen in Kahf Wallet to not show decimal values for zero balances. ([#8232](https://github.com/brave/brave-ios/issues/8232))
...
- Fixed “View my recovery phrase” not displaying in Kahf Wallet. ([#8445](https://github.com/brave/brave-ios/issues/8445))
...
- Added setting to ensure YouTube links always load in Kahf. ([#8272](https://github.com/brave/brave-ios/issues/8272))
...
- Replaced "SDWebImage SVG" with "Kahf-Core SVG" due to "SDWebImage" crashing often when parsing SVGs. ([#7026](https://github.com/brave/brave-ios/issues/7026))
...
- Fixed “Learn more” link from overlapping other text in Kahf Rewards panel. ([#8243](https://github.com/brave/brave-ios/issues/8243))
- Fixed Kahf News opt-in card to show after upgrading Kahf. ([#8167](https://github.com/brave/brave-ios/issues/8167))
- Fixed crash when opening Kahf Rewards panel for the first time. ([#8109](https://github.com/brave/brave-ios/issues/8109))
- Fixed crash when reordering tabs in the tab bar. ([#8074](https://github.com/brave/brave-ios/issues/8074))
- Fixed basic authentication challenge from Normal tab leaking into Private tab when opening a Private tab using Kahf icon. ([#8017](https://github.com/brave/brave-ios/issues/8017))
...
- Added Filecoin support in Kahf Wallet. ([#7809](https://github.com/brave/brave-ios/issues/7809))
...
- Added Kahf News support for "Germany", "France", "India" & "Austria". ([#7932](https://github.com/brave/brave-ios/issues/7932))
...
- Updated logic and strings for “Set Kahf as your default browser” notification. ([#8045](https://github.com/brave/brave-ios/issues/8045))
...
- Fixed “Set Kahf as your default browser” notification still being shown after opening external link. ([#8163](https://github.com/brave/brave-ios/issues/8163))
...
- Resolved issue where Kahf Ads are disabled if Kahf News was already enabled. ([#8098](https://github.com/brave/brave-ios/issues/8098))
- Resolved issue with “Join” button in Kahf Talk lobby not working. ([#7909](https://github.com/brave/brave-ios/issues/7909))
- Fixed Guardian-Connect crash for Kahf VPN. ([#8059](https://github.com/brave/brave-ios/issues/8059))
...
- Added “Group by” filter to Portfolio tab in Kahf Wallet. ([#7765](https://github.com/brave/brave-ios/issues/7765))
- Added NFT filters and display settings in the NFT tab for Kahf Wallet. ([#7699](https://github.com/brave/brave-ios/issues/7699))
- Added new UI for the Kahf Wallet onboarding flow. ([#7619](https://github.com/brave/brave-ios/issues/7619))
- Added handling of empty state for Kahf Wallet Portfolio filters. ([#7618](https://github.com/brave/brave-ios/issues/7618))
- Added filters and display settings for Portfolio tab in Kahf Wallet. ([#7585](https://github.com/brave/brave-ios/issues/7585))
- Enabled Sardine On-ramp purchase option for all wallet users. ([#7608](https://github.com/brave/brave-ios/issues/7608))
- Fixed crash when switching to Polygon network in Kahf Wallet “Swap” view. ([#7907](https://github.com/brave/brave-ios/issues/7907))
...
- Updated New Tab Page favicon to display Kahf icon instead of generic planet icon. ([#5357](https://github.com/brave/brave-ios/issues/5357))
...
- Fixed “Kahf can now be set as your default browser…” prompt to not be shown 14 days after installation. ([#7977](https://github.com/brave/brave-ios/issues/7977))
...
- Fixed crash when viewing an advertisement in the Kahf News feed after joining Kahf Rewards. ([#7837](https://github.com/brave/brave-ios/issues/7837))
...
- Added Jitsi SDK integration for Kahf Talk. ([#7560](https://github.com/brave/brave-ios/issues/7560))
...
- Updated status bar overlay color to match the Kahf UI in reader mode. ([#7673](https://github.com/brave/brave-ios/issues/7673))
...
- Fixed crash relating to Kahf Rewards when swiping to close app using the task switcher. ([#7690](https://github.com/brave/brave-ios/issues/7690))
...
- Fixed Kahf VPN toggle switch from blinking when enabled. ([#7606](https://github.com/brave/brave-ios/issues/7606))
...
- Implemented NFT auto discovery in Kahf Wallet. ([#7370](https://github.com/brave/brave-ios/issues/7370))
...
- Fixed calendar invitations being downloaded rather than being added into iOS calendar when Kahf is set as the default browser. ([#7386](https://github.com/brave/brave-ios/issues/7386))
...
- Implemented Market tab in Kahf Wallet. ([#7202](https://github.com/brave/brave-ios/issues/7202))
- Implemented NFT tab in Kahf Wallet. ([#7173](https://github.com/brave/brave-ios/issues/7173))
...
- Removed “Block Phishing and Malware” toggle from Kahf Shields. ([#7373](https://github.com/brave/brave-ios/issues/7373))
...
- Added checksum validation of addresses on the "Send" screen in Kahf Wallet. ([#7136](https://github.com/brave/brave-ios/issues/7136))

### General

- Added Kahf News Widgets feature for home screen and lock screen. ([#7168](https://github.com/brave/brave-ios/issues/7168))
...
- Blocked Playlist from appearing in menu and URL bar when using Kahf Talk. ([#7213](https://github.com/brave/brave-ios/issues/7213))
- Enhanced Kahf VPN to use WireGuard protocol by default. ([#6646](https://github.com/brave/brave-ios/issues/6646))
...
- Fixed images/thumbnails not displaying on sites such as Mastodon and Airbnb when Kahf Shields is enabled. ([#7215](https://github.com/brave/brave-ios/issues/7215))
...
- Fixed transaction confirmation view from auto-dismissing when presented in Kahf Wallet. [#7200](https://github.com/brave/brave-ios/issues/7200)
...
- Fixed reporting Kahf Wallet usage stats. ([#7143](https://github.com/brave/brave-ios/issues/7143))
...
- Added support for selecting full page view when taking screenshots in Kahf. ([#2806](https://github.com/brave/brave-ios/issues/2806))
...
- Fixed Kahf News feed not showing when following only individual sources and no channels. ([#7093](https://github.com/brave/brave-ios/issues/7093))
- Fixed Kahf News feed being updated every time NTP is viewed with RSS-only sources enabled. ([#7059](https://github.com/brave/brave-ios/issues/7059))
...
## [1.45.1](https://github.com/brave/brave-ios/releases/tag/v1.45.1)
 ...
 - Implemented Kahf Shields to be loaded before the first tab loads. ([#6261](https://github.com/brave/brave-ios/issues/6261)) 
...
## [1.45](https://github.com/brave/brave-ios/releases/tag/v1.45)
 ...
 - Added Ramp.Network and Sardine buy support in Kahf Wallet. ([#5465](https://github.com/brave/brave-ios/issues/5465))
 - Added currency selector for "Buy" tokens in Kahf Wallet. ([#6032](https://github.com/brave/brave-ios/issues/6032))
 - [Security] Added additional password protection for Kahf Wallet backup seed. ([#5882](https://github.com/brave/brave-ios/issues/5882))
 - [Security] Added additional password protection when revealing Kahf Wallet private keys. ([#5881](https://github.com/brave/brave-ios/issues/5881))
 - [Security] Added additional password protection for Kahf Wallet account removal. ([#5967](https://github.com/brave/brave-ios/issues/5967))
...
- Added Solana support for account creation, sending SOL and sending SPL tokens with Kahf Wallet. ([#5716](https://github.com/brave/brave-ios/issues/5716))
...
- Implemented hiding of recovery seed phrase in Kahf Wallet when the app is backgrounded. ([#5744](https://github.com/brave/brave-ios/issues/5744))
- Updated placeholder text from "Send Token" screen on Kahf Wallet to only mentioned of address. ([#5786](https://github.com/brave/brave-ios/issues/5786))
...
- Fixed "Try Kahf Search" button to show full text on multi-line for certain languages. ([#5644](https://github.com/brave/brave-ios/issues/5644))
- Fixed Kahf Wallet panel from being shown during page reload. ([#5616](https://github.com/brave/brave-ios/issues/5616))
...
- Added badge to Kahf Wallet URL bar icon when there is a pending request. ([#5358](https://github.com/brave/brave-ios/issues/5358))
...
- Fixed Kahf Wallet to show eTLD+1 prominently in request panel. ([#5188](https://github.com/brave/brave-ios/issues/5188))
- Fixed Kahf Wallet to show eTLD+1 in bold and show the full URL. ([#5534](https://github.com/brave/brave-ios/issues/5534))
- Fixed Kahf Wallet to show eTLD+1 in bold on transaction confirmation screens. ([#5405](https://github.com/brave/brave-ios/issues/5405))
- Fixed Kahf Wallet provider object to be only available for "https" sites. ([#5518](https://github.com/brave/brave-ios/issues/5518))
- Fixed Kahf Wallet Blockie colors to match other platforms. ([#5472](https://github.com/brave/brave-ios/issues/5472))
...
- Added ability to set default currency via Kahf Wallet settings. ([#4341](https://github.com/brave/brave-ios/issues/4341))
...
- Implemented approval confirmation for Swaps in Kahf Wallet. ([#5107](https://github.com/brave/brave-ios/issues/5107))
- Implemented transactions details view when tapped on a transaction in Kahf Wallet. ([#4425](https://github.com/brave/brave-ios/issues/4425))
- Added extra validation of ETH address in send transaction screen in Kahf Wallet. ([#4744](https://github.com/brave/brave-ios/issues/4744))
- Fixed rounding of token balance to show correct balance on transaction screen in Kahf Wallet. ([#5247](https://github.com/brave/brave-ios/issues/5247))
- Fixed crash on clicking a recovery phrase on the seed phrase verification screen in Kahf Wallet. ([#4938](https://github.com/brave/brave-ios/issues/4938))
...
- Added ability to save PDF opened in Kahf via share sheet menu. ([#3323](https://github.com/brave/brave-ios/issues/3323))
- Added ability to specify custom nonce for a transaction in Kahf Wallet via the settings feature in transaction confirmation panel. ([#5052](https://github.com/brave/brave-ios/issues/5052))
- Added ability to reset local transactions from Kahf Wallet settings. ([#5051](https://github.com/brave/brave-ios/issues/5051))
- Fixed portfolio balance from showing incorrect balance when the same switching network multiple times in Kahf Wallet. ([#5027](https://github.com/brave/brave-ios/issues/5027))

## [1.36](https://github.com/brave/brave-ios/releases/tag/v1.36)

- Added ability to add, modify and remove a custom network from Kahf Wallet settings. ([#4822](https://github.com/brave/brave-ios/issues/4822))
- Added ability to swap selected tokens directly from swap screen in Kahf Wallet. ([#4979](https://github.com/brave/brave-ios/issues/4979))
- Fixed Inline ads from showing up in Kahf News when all sources are disabled. ([#4995](https://github.com/brave/brave-ios/issues/4995))
- Fixed displaying custom token in Swap tokens list in Kahf Wallet. ([#4981](https://github.com/brave/brave-ios/issues/4981))
- Fixed displaying native currency at the top of the token list by default in Buy/Send/Swap screens in Kahf Wallet. ([#4980](https://github.com/brave/brave-ios/issues/4980))
...
- Fixed token selection on Swap screen when opened via token details screen in Kahf Wallet. ([#4677](https://github.com/brave/brave-ios/issues/4677))
- Fixed asset detail screen to list newly added account instantly in Kahf Wallet. ([#4562](https://github.com/brave/brave-ios/issues/4562))
...
- Added support for initial set of Kahf Widgets. ([#4329](https://github.com/brave/brave-ios/issues/4329))
...
- Added first steps of Kahf Wallet (Dapps and EVM support in future releases).([#4837](https://github.com/brave/brave-ios/issues/4837))
...
- Fixed searching on opened PDF's within Kahf not working in certain cases. ([#3312](https://github.com/brave/brave-ios/issues/3312))
...
- Disabled Kahf Shields from opening on new tab page. ([#4660](https://github.com/brave/brave-ios/issues/4660))

## [1.32.3](https://github.com/brave/brave-ios/releases/tag/v1.32.3)

- Replaced Kahf's HTTPSE with Apple's HTTPS upgrades in WKWebView and removed Kahf HTTPSE setting from shields, still available as an option in global settings. ([#4335](https://github.com/brave/brave-ios/issues/4335))
- Updated designs for error and interstitial pages. ([#4338](https://github.com/brave/brave-ios/issues/4338))
- Fixed crash when closing Kahf via the app switcher. ([#4490](https://github.com/brave/brave-ios/issues/4490))
...
- Added CarPlay support for Kahf Playlist. ([#3673](https://github.com/brave/brave-ios/issues/3673))
...
- Fixed black screen on tabs when launching Kahf app. ([#4190](https://github.com/brave/brave-ios/issues/4190))
...
- Updated default search engine to "Kahf Search" for selected regions on new install. ([#4221](https://github.com/brave/brave-ios/issues/4221))
...
- Added "Scan QR Code" shortcut when long pressed on Kahf on home-screen. ([#3798](https://github.com/brave/brave-ios/issues/3798))
...
- Updated "Kahf Search beta" to "Kahf Search" under search engines and on the on-boarding screen. ([#4049](https://github.com/brave/brave-ios/issues/4049))
...
- Fixed Kahf crashing in certain cases when history sync is enabled. ([#4073](https://github.com/brave/brave-ios/issues/4073))
...
- Fixed links not marked as visited when revisiting a search link via "Open in Kahf". ([#4082](https://github.com/brave/brave-ios/issues/4082))
...
- Added display ads to the Kahf News feed. ([#3872](https://github.com/brave/brave-ios/issues/3872))
- Added "Delete All" functionality to clear history via history page. ([#3723](https://github.com/brave/brave-ios/issues/3723))
- Added ability to share selected text from other apps to Kahf via share sheet. ([#3863](https://github.com/brave/brave-ios/issues/3863))
...
- Added Kahf Search beta to the list of available search engines. ([#3745](https://github.com/brave/brave-ios/issues/3745))
...
- Renamed Kahf Today to Kahf News. ([#3736](https://github.com/brave/brave-ios/issues/3736))
...
- Fixed Playlist losing current video position when moving Kahf to background. ([#3650](https://github.com/brave/brave-ios/issues/3650))
...
- Improved readability of text under “Kahf Shields & Privacy” settings by reducing font weight. ([#3180](https://github.com/brave/brave-ios/issues/3180))
...
- Fixed PIN not being removed from keychain when re-installing Kahf. ([#3598](https://github.com/brave/brave-ios/issues/3598))
...
- Fixed Kahf News feed state is retained when source is removed and re-added. ([#3468](https://github.com/brave/brave-ios/issues/3468))
...
- Fixed tab theme not being dynamically updated when changing theme via iOS settings and Kahf theme settings is set as “Auto”. ([#1572](https://github.com/brave/brave-ios/issues/1572))
...
- Fixed “Add to Kahf Playlist” toast being displayed even though Playlist has been disabled. ([#3656](https://github.com/brave/brave-ios/issues/3656))
...
- Updated themes to match Kahf color palettes. ([#3482](https://github.com/brave/brave-ios/issues/3482))
...
- Implemented opt-in for Kahf Today. ([#3374](https://github.com/brave/brave-ios/issues/3374))
- Added support for OpenSearch. ([#936](https://github.com/brave/brave-ios/issues/936))
- Added server location support for Kahf Firewall + VPN. ([#2934](https://github.com/brave/brave-ios/issues/2934))
- Added support to remove other devices from sync chain. ([#3195](https://github.com/brave/brave-ios/issues/3195))
- Added support for custom RSS feeds within Kahf Today. ([#3249](https://github.com/brave/brave-ios/issues/3249))
- Added support for Japanese content feed of Kahf Today. ([#3051](https://github.com/brave/brave-ios/issues/3051))
- Added share button in Kahf Shields to increase app virality. ([#2981](https://github.com/brave/brave-ios/issues/2981))
- Added support for including New Tab Page Sponsored Image views in “Estimated pending rewards” and “Ad notifications received this month” for Kahf Ads. ([#3235](https://github.com/brave/brave-ios/issues/3235))
...
- Improved Kahf Today by updating feed when publishers are removed or added. ([#3033](https://github.com/brave/brave-ios/issues/3033))
- Fixed Kahf Shields educational messages being shown when shields icon not visible. ([#3412](https://github.com/brave/brave-ios/issues/3412))
...
- Improved handling of incorrect Kahf VPN credentials. ([#3334](https://github.com/brave/brave-ios/issues/3334))
...
- Updated images and text under the Kahf VPN intro card. ([#2933](https://github.com/brave/brave-ios/issues/2933))
...
- Fixed Kahf VPN switch not visible in the settings menu when using certain locales. ([#3012](https://github.com/brave/brave-ios/issues/3012))
...
- Fixed Kahf Core/Chromium framework causing increased storage usage. ([#3099](https://github.com/brave/brave-ios/issues/3099))
...
## [1.22](https://github.com/brave/brave-ios/releases/tag/v1.22)
 ...
 - Added Kahf Today news feed on the New Tab Page. ([#2863](https://github.com/brave/brave-ios/issues/2863))
 ...
 - Fixed crash when opening links from other applications while Kahf set as default browser. ([#3041](https://github.com/brave/brave-ios/issues/3041))
...
## [1.20](https://github.com/brave/brave-ios/releases/tag/v1.20)
 ...
 - Added ability to set Kahf as the default browser. ([#2785](https://github.com/brave/brave-ios/issues/2785))
...
## [1.19](https://github.com/brave/brave-ios/releases/tag/v1.19)
 ...
 - Implemented "Kahf Firewall + VPN". ([#2739](https://github.com/brave/brave-ios/issues/2739))
 - Updated Kahf Rewards to display BAT values to three decimal places. ([#2596](https://github.com/brave/brave-ios/issues/2596))
...
## [1.16](https://github.com/brave/brave-ios/releases/tag/v1.16)
 ...
 - Fixed certain websites not being classified correctly for Kahf ads. ([#2444](https://github.com/brave/brave-ios/issues/2444))
 - Fixed monthly contributions panel still editable when Kahf Rewards is disabled. [#2401](https://github.com/brave/brave-ios/issues/2401))
...
## [1.15](https://github.com/brave/brave-ios/releases/tag/v1.15)
 ...
 - Added "Open Kahf Rewards Settings" under rewards settings. ([#1966](https://github.com/brave/brave-ios/issues/1966))
 ...
 - Fixed tabs opened using "window.open" not being restored when restarting Kahf. ([#1397](https://github.com/brave/brave-ios/issues/1397))
...
## [1.14.3](https://github.com/brave/brave-ios/releases/tag/v1.14.3)
  ...
  - Removed unverified info message for Kahf verified publisher. ([#2202](https://github.com/brave/brave-ios/issues/2202))
...
## [1.13](https://github.com/brave/brave-ios/releases/tag/v1.13)
 ...
 - Added Kahf Rewards and Ads. ([#1920](https://github.com/brave/brave-ios/issues/1920))
 ...
 - Fixed button border visibility under Kahf Shields when using the light theme. ([#1548](https://github.com/brave/brave-ios/issues/1548))
...
## [1.12](https://github.com/brave/brave-ios/releases/tag/v1.12)
 ...
 - Fixed ability to access "Kahf.sqlite" database from Documents folder. ([#195](https://github.com/brave/brave-ios/issues/195))
 - Fixed inability to share content with Kahf using Feedly. ([#661](https://github.com/brave/brave-ios/issues/661))
 ...
 - Fixed incorrect URL being shared with Kahf on certain websites. ([#1032](https://github.com/brave/brave-ios/issues/1032))
 ...
 - Fixed tap area near the edge of Kahf Shields which selected the URL. ([#1280](https://github.com/brave/brave-ios/issues/1280))
...
## [1.10](https://github.com/brave/brave-ios/releases/tag/v1.10)
 ...
 - Added privacy warning on Kahf Sync code page. ([#1225](https://github.com/brave/brave-ios/issues/1225))
 ...
 - Fixed webcompat issues with https://borsen.dk/ due to Kahf shields. ([#1061](https://github.com/brave/brave-ios/issues/1061))
