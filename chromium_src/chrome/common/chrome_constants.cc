...
const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("kahf");
const base::FilePath::CharType kHelperProcessExecutableName[] =
...
#elif BUILDFLAG(IS_ANDROID)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("kahf");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("kahf");
#elif BUILDFLAG(IS_POSIX)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("kahhf");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("kahf");
#endif  // OS_*
