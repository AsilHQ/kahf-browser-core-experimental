...
_BRAVE_VALUES = {
  ...
  'win_config': {
    'win': {
      'reg_mandatory_key_name': 'Software\\Policies\\Halalz\\Brave',
      'reg_recommended_key_name':
        'Software\\Policies\\Halalz\\Brave\\Recommended',
      ...
      'namespace': 'Halalz.Policies.Brave',
    },
  },
  ...
  'admx_using_namespaces': {
    'Brave': 'Halalz.Policies'  # prefix: namespace
  },
