      ...
      kResources{{
          ...
          {"newtab",
           {{"img/toolbar/menu_btn.svg", IDR_BRAVE_COMMON_TOOLBAR_IMG},
            ...
            // New tab Backgrounds
            {"ekrem-osmanoglu-2R0gbZXaUqM-unsplash.webp",
             IDR_BRAVE_NEW_TAB_BACKGROUND1},
            {"ayse-bek-YLdYVzHopto-unsplash.webp",
              IDR_BRAVE_NEW_TAB_BACKGROUND2},
            {"fatih-yurur-kNSREmtaGOE-unsplash.webp",
              IDR_BRAVE_NEW_TAB_BACKGROUND3},
            {"fahrul-azmi-gyKmF0vnfBs-unsplash.webp",
                IDR_BRAVE_NEW_TAB_BACKGROUND4},
            {"dhru-j-r7H8kkoYyCY-unsplash.webp",
